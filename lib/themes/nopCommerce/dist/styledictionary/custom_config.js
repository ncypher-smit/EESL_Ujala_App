...
//custom transform that converts a font size value to double required by Flutter
StyleDictionary.registerTransform({
    name: 'size/toDouble',
    type: 'value',
    ...
    transformer: function (token) {
        return Number(token.original.value).toFixed(2);
    }
});
...
StyleDictionary.registerTransformGroup({
    ...
    transforms: [
        ...
        'size/toDouble', //custom transform
