...
part 'news_paging_filtering_model_dto.g.dart';
...
/// * [customProperties] 
@BuiltValue()
abstract class NewsPagingFilteringModelDto implements Built<NewsPagingFilteringModelDto, NewsPagingFilteringModelDtoBuilder> {
  ...
  NewsPagingFilteringModelDto._();

  factory NewsPagingFilteringModelDto([void updates(NewsPagingFilteringModelDtoBuilder b)]) = _$NewsPagingFilteringModelDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NewsPagingFilteringModelDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NewsPagingFilteringModelDto> get serializer => _$NewsPagingFilteringModelDtoSerializer();
}

class _$NewsPagingFilteringModelDtoSerializer implements PrimitiveSerializer<NewsPagingFilteringModelDto> {
  @override
  final Iterable<Type> types = const [NewsPagingFilteringModelDto, _$NewsPagingFilteringModelDto];

  @override
  final String wireName = r'NewsPagingFilteringModelDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    NewsPagingFilteringModelDto object, {
  ...
  void _deserializeProperties(
    ...
    required NewsPagingFilteringModelDtoBuilder result,
  ...
  @override
  NewsPagingFilteringModelDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = NewsPagingFilteringModelDtoBuilder();
