...
part 'contact_vendor_model_dto.g.dart';
...
/// * [customProperties] 
@BuiltValue()
abstract class ContactVendorModelDto implements Built<ContactVendorModelDto, ContactVendorModelDtoBuilder> {
  ...
  ContactVendorModelDto._();

  factory ContactVendorModelDto([void updates(ContactVendorModelDtoBuilder b)]) = _$ContactVendorModelDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ContactVendorModelDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ContactVendorModelDto> get serializer => _$ContactVendorModelDtoSerializer();
}

class _$ContactVendorModelDtoSerializer implements PrimitiveSerializer<ContactVendorModelDto> {
  @override
  final Iterable<Type> types = const [ContactVendorModelDto, _$ContactVendorModelDto];

  @override
  final String wireName = r'ContactVendorModelDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ContactVendorModelDto object, {
  ...
  void _deserializeProperties(
    ...
    required ContactVendorModelDtoBuilder result,
  ...
  @override
  ContactVendorModelDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ContactVendorModelDtoBuilder();
