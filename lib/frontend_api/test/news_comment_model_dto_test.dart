...
// tests for NewsCommentModelDto
void main() {
  final instance = NewsCommentModelDtoBuilder();
  // TODO add properties to the builder and call build()

  group(NewsCommentModelDto, () {
    // int customerId
    ...
    test('to test the property `customerAvatarUrl`', () async {
      // TODO
    });

    // String commentTitle
    test('to test the property `commentTitle`', () async {
      // TODO
    });
    ...
    test('to test the property `allowViewingProfiles`', () async {
      // TODO
    });
